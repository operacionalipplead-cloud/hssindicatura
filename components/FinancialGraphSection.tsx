...
const FinancialGraphSection: React.FC = () => {
  return (
    <section id="results" className="bg-[#031926] py-24 md:py-32 px-6 relative overflow-hidden scroll-mt-28">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#C9943C]/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 gap-8">
            ...
            <div className="bg-[#333333]/50 p-4 rounded border border-[#A9A9A9]/20 backdrop-blur-sm">
          ...
          <div className="mt-12 text-center">
            <a 
              href="#contact"
              className="inline-flex items-center justify-center px-8 py-3 border border-[#C9943C] text-[#C9943C] font-bold text-lg rounded hover:bg-[#C9943C] hover:text-[#031926] transition-all duration-300 group"
            >
          ...
          <p className="text-center text-[#A9A9A9] text-xs mt-8 opacity-60">
